...
**Этап 00 — Планирование (завершён)**

План готов, структура папок создана, ожидается старт разработки.

## Прогресс по этапам

| # | Этап | Статус |
|---|---|---|
| 01 | bootstrap — каркас Go-проекта | ⬜ не начат |
| 02 | config — env + yaml (HA, GigaChat, TG) | ⬜ не начат |
